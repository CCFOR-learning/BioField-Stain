#!/usr/bin/env python3
"""
Evaluate BioFieldStain on MIST dataset (per-stain evaluation).
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate BioFieldStain on MIST')
    ...
    print("=" * 70)
    print(f"EVALUATION: BioField-Stain on MIST")
